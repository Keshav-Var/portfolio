...
import 'package:portfolio/app/sections/about/image_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      padding: EdgeInsets.symmetric(horizontal: width / 10)
          .copyWith(bottom: width < 1024 ? 40 : 100), // Reduce padding for mobile
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              if (isDesktop) ImageWidget(), // Show image only on desktop
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      ...
                      style: TextStyle(
                        fontSize: isFontSize(context, isDesktop?18:isMobile?14:16),
